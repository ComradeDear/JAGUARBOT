...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](TeamLion-X/Lion-X)**",
...
async def ammastar(Lionstart):
  
    if Lionstart.fwd_from:
    ...
    await eor(Lionstart, "I am A Star")
    ...
    for i in animation_ttl:
        ...
        await Lionstart.edit(animation_chars[i % 11])
