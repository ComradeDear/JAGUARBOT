...
async def download(event):
    ...
    try:
        ...
        await Lion.edit("Committing to Github....")
        await git_commit(downloaded_file_name, Lion)


async def git_commit(file_name, Lion):
    content_list = []
    ...
    for i in content_list:
        ...
        if i == 'ContentFile(path="' + file_name + '")':
            return await Lion.edit("`File Already Exists`")
            create_file = False
    file_name = "Lion/plugins/" + file_name
    if create_file == True:
        ...
        try:
            ...
            await eod(Lion, "Cannot Upload Plugin")
    else:
        return await eod(Lion, "`Committed Suicide`")
