...
Lion_pic = Config.PMPERMIT_PIC or "https://telegra.ph/file/8fcbf4621cd6c9dc46897.jpg"
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        result = None
        query = event.text
        if event.query.user_id == bot.uid and query == "Lion_help":
            rev_text = query[::-1]
            ...
            alv_btn = [
                [Button.url(f"{LION_USER}", f"tg://openmessage?user_id={ForGo10God}")],
            ...
            hel_l = LION_FIRST.format(Lion_mention, mssge)
            result = builder.photo(
                file=Lion_pic,
                text=hel_l,
                buttons=[
            ...
            result = builder.article(
                ...
                buttons=[
                    [Button.url("📑 Repo 📑", "https://t.me/Lion_chat")],
                    [Button.url("🚀 Deploy 🚀", "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FTeamLion-X%2FLion-X&template=https%3A%2F%2Fgithub.com%2Fthe-Lion%2FLion")],
                ],
            )
            ...
            result = builder.article(
                "@LionXUpdates",
                text="""**Hey! This is [ʟɨօռ-Ӽ](https://t.me/its_Lion) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 CHANNEL 🔥", "https://t.me/LionXUpdates"),
                        custom.Button.url(
                            "⚡ GROUP ⚡", "https://t.me/Lion_chat"
                        ),
                    ],
                    [
                        custom.Button.url(
                            "✨ REPO ✨", "https://github.com/TeamLion-X/Lion-X"),
                        custom.Button.url
                    (
