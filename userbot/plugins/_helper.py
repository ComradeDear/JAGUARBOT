...
**⚡ ʟɛɢɛռɖaʀʏ ᴀғ ʟɨօռ-Ӽ ⚡**
  ...
  •        [🚀 Deploy 🚀](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FTeamLion-X%2FLion-X&template=https%3A%2F%2Fgithub.com%2Fthe-Lion%2FLion)
...
async def yardim(event):
    ...
    if tgbotusername is not None:
        results = await event.client.inline_query(tgbotusername, "Lion_help")
