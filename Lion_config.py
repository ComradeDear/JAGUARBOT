# IF YOU ARE HOSTING LION ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "⚡ ʟɛɢɛռɖֆ օʄ ʟɨօռ-Ӽ⚡")
    ALIVE_PIC = os.environ.get("ALIVE_PIC", "https://telegra.ph/file/7da0f8ec82e322542b533.jpg")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "ʟɛɢɛռɖֆ օʄ ʟɨօռ-Ӽ")
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "LionXUpdates")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://telegra.ph/file/7da0f8ec82e322542b533.jpg")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/TeamLion-X/Lion-X")
